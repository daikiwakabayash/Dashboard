...
export const DEFAULT_FLAGS = Object.freeze({
  ...
  cc_ai_trial: false,        // @AI 実接続の検証（本部/root限定・検証用Roomのみ）
  cc_events_all_staff: false,// 勉強会・イベントをスタッフ／オーナーにも開く（⚠️ 公開範囲の拡大）
  cc_home: false,            // 経営ホーム（重要指標・要確認店舗・承認待ち・AIへの質問）
  cc_ai_agents: false,       // 業務AIの提案を既存画面に出す（⚠️ ③が接続するまで何も出ない）
  cc_daily_report: false,    // 日報・集客速報をグループチャットへ自動送信（⚠️ ONにすると実際にチャットへ流れる）
