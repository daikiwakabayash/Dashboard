...
- **受付日時ベースのコホート（重要）**: マーケ指標は「受付日時(received_at)が選択期間内の新規予約」を1コホートとして追跡（来店が翌月でも含む／前月受付は除外）。新規予約=期間内に受付がある新規客数、新規来店=そのうち初回来店(visited_completed/completed)、キャンセル=予約−来店、入会=joined、売上=LTV累計。KPI/獲得ファネル/媒体別・店舗別コホート/受付日分析/新規顧客一覧すべて custRows(new-customers) から算出。広告費/クリック/CPA/ROAS のみ by-channel から媒体名で名寄せ
