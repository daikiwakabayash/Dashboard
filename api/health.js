export default function handler(req, res) {
  ...
  res.status(200).json({
    ...
    env: {
      ...
      planStore: {
        kv: !!((process.env.KV_REST_API_URL || process.env.UPSTASH_REDIS_REST_URL || process.env.REDIS_REST_API_URL) && (process.env.KV_REST_API_TOKEN || process.env.UPSTASH_REDIS_REST_TOKEN || process.env.REDIS_REST_API_TOKEN)),
