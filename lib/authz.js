...
export const ROLE_ALIASES = Object.freeze({ hq: 'admin', brand_admin: 'root', shop_admin: 'owner', shop_staff: 'staff' });
...
export function can(actor, action, target) {
  ...
  // 2) AIエージェントの禁止（最優先。role では回避できない）
  if (a.source === 'agent') {
