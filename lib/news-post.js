...
export function coverStyle(post, opts = {}) {
  ...
  if (imgId) return { imgId, kicker: '', journal: '', line1: '', line2: '', heroWords: [], caption: '', tone: '' };
